...
-- @[simp] theorem coEndoYonedaLemma1
--     {btc : binaryTypeConstructor}
--     {functionalCategory : FunctionalCategory btc}
--     [FunctionalCategoryProperties btc]
--     [FunctorProperties functionalCategory.functionalFunctor]
...
--   let foo : btc Unit ((Global btc ≻ Id) (utc t)) := gₛₜ btc_s_t ≫ τ ≫ γν
--   let bar : btc Unit ((Global btc ≻ Id) (utc t)) := gₛₜ btc_s_t ≫ σ

--   let baz : btc Unit (btc s t) := gₛₜ btc_s_t

--   -- let foo1 : function (btc Unit (btc s t)) (btc Unit ((Global btc ≻ Id) (utc t))) :=
--   --   (. >> (τ ≫ γν))

--   ((. ≫ (τ ≫ γν)) : function (btc Unit (btc s t)) (btc Unit ((Global btc ≻ Id) (utc t))))
--     = (. ≫ σ) :=
...
--       = (. ≫ σ)
--       := sorry
--       -- := funext λ _ ↦ pointfreeCoEndoYonedaLemma1
